...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { airplane_type_id: @airplane.airplane_type_id, name: @airplane.name } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { airplane_type_id: @airplane.airplane_type_id, name: @airplane.name } }
